...
func (x *OAuthLoginResponse) GetTokens() *AuthTokens {
	if x != nil {
		return x.Tokens
	}
	return nil
...
var file_identity_v1_auth_proto_goTypes = []any{
	...
	(*OAuthLoginRequest)(nil),  // 4: identity.v1.OAuthLoginRequest
	(*OAuthLoginResponse)(nil), // 5: identity.v1.OAuthLoginResponse
